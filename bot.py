...
# The Arabic Prompt
_FORMAT_SYSTEM = """أنت "مُعيد بناء" (Reconstructor)، لست محرراً. مدخلاتك خراطة صوتية أخرجها Whisper، وليست نصاً كتبه إنسان. مهمتك: استعادة ما أراده الشيخ، لا حفظ ما أخطأ فيه Whisper.
